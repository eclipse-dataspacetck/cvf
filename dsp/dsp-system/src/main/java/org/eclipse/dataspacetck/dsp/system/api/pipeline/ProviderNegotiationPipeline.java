 ...
 */
public class ProviderNegotiationPipeline extends AbstractNegotiationPipeline<ProviderNegotiationPipeline> {
    ...
    public ProviderNegotiationPipeline(ProviderNegotiationClient negotiationClient,
    ...
    public ProviderNegotiationPipeline sendCounterOfferMessage(String offerId, String targetId, boolean expectError) {
        stages.add(() -> {
            ...
            if (!expectError) {
                consumerConnector.getConsumerNegotiationManager().counterOffer(consumerId);
            }
    ...
    public ProviderNegotiationPipeline sendTermination(boolean expectError) {
        stages.add(() -> {
            ...
            if (!expectError) {
                consumerConnector.getConsumerNegotiationManager().terminate(consumerId);
            }
        });
        return this;
    }
    ...
    public ProviderNegotiationPipeline acceptLastOffer() {
        stages.add(() -> {
            ...
            consumerConnector.getConsumerNegotiationManager().agree(consumerId);
    ...
    public ProviderNegotiationPipeline sendVerifiedEvent(boolean expectError) {
        stages.add(() -> {
            ...
            if (!expectError) {
                consumerConnector.getConsumerNegotiationManager().verify(consumerId);
            }
